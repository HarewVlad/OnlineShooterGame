...
static const XMFLOAT2 s_WeaponSize = {16, 16};
...
static const float s_ShootFrequency = 0.05f; // Bullet per second // TODO: Different guns have different shot speed, add that
...
static const float s_DummyRegenRate = 50.0f; // HP per second